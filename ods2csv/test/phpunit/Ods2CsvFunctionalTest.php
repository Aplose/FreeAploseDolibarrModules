...
/**
 * \file    test/phpunit/Ods2CsvFunctionalTest.php
 * \ingroup ods2csv
 ...
 * @package Testods2csv
 */
class Ods2CsvFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/ods2csv/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('ods2csv/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/ods2csv/admin/about.php');
		$this->authenticate();
		return $this->assertContains('ods2csv/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('ods2csvwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modOds2Csv_Ods2CsvTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modOds2Csv_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
