...
/**
 * \file    test/phpunit/BackMyModulesFunctionalTest.php
...
/**
 * Class BackMyModulesFunctionalTest
 *
 ...
 *
 * @package Testbackmymodules
 */
class BackMyModulesFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	private static $module_id = 109012; // TODO: autodetect?
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modBackMyModules')->click();
		} else {
			// Disable the module
			$this->byHref('modBackMyModules')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/backmymodules/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('backmymodules/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/backmymodules/admin/about.php');
		$this->authenticate();
		return $this->assertContains('backmymodules/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('backmymoduleswidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modBackMyModules_BackMyModulesTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modBackMyModules_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
