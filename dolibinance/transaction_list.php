...
/**
 *   	\file       transaction_list.php
 * 		\ingroup    dolibinance
 * 		\brief      List page for transaction
 */
...
if ($enablepermissioncheck) {
    $permissiontoread = $user->hasRight('dolibinance', 'transaction', 'read');
    $permissiontoadd = $user->hasRight('dolibinance', 'transaction', 'write');
    $permissiontodelete = $user->hasRight('dolibinance', 'transaction', 'delete');
} else {
    $permissiontoread = 1;
    $permissiontoadd = 1;
...
$form = new Form($db);
$now = dol_now();
$title = $langs->trans("Transactions");
//$help_url = "EN:Module_Transaction|FR:Module_Transaction_FR|ES:Módulo_Transaction";
$help_url = '';
$morejs = array();
$morecss = array();
...
$topicmail = "SendTransactionRef";
$modelmail = "transaction";
$objecttmp = new Transaction($db);
