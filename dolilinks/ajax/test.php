...
/**
 *       \file       htdocs/dolilinks/ajax/test.php
 *       \brief      File to return Ajax response on test list request
 */
...
dol_include_once('/dolilinks/class/test.class.php');
...
// Security check
if (!$user->hasRight('dolilinks', 'test', 'write')) {
	accessforbidden();
}
...
dol_syslog("Call ajax dolilinks/ajax/test.php");
