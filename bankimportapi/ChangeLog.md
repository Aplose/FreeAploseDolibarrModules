...
## 2.33
FIX : update compatibility for version 23 of Dolibarr (salary payment datep, charge payment bank_url type, operator precedence on payment results)
FIX : Qonto API pagination (page/per_page), organization endpoint fallback, bank_account_id support
FIX : file transfer condition parentheses in ajax import scripts

## 2.32
FIX : update compatibility for version 21 of dolibarr morefilter param for function $form->select_dolusers (salary form) need new filter format

## 2.31
FIX : update compatibility for version 20 of dolibarr (add prop datep to payment expense report object)

## 2.30
FIX : update compatibility for version 21 of dolibarr (add prop period to chargesocial object)

## 2.29
FIX : update compatibility for version 20 of Dolibarr for CSV import

## 2.28
FIX : update compatibility for version 20 of Dolibarr for Qonto
