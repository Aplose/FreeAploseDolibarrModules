	...
	<table>
		...
		<tr>
			...
			<?php
				...
				//function select_dolusers($selected = '', $htmlname = 'userid', $show_empty = 0, $exclude = null, $disabled = 0, $include = '', $enableonly = '', $force_entity = '', $maxlength = 0, $showstatus = 0, $morefilter = '', $show_every = 0, $enableonlytext = '', $morecss = '', $notdisabled = 0, $outputmode = 0, $multiple = false, $forcecombo = 0)

				print $form->select_dolusers($selected, $htmlname, $show_empty, $exclude, $disabled, '', '', 0, 0, 0, '(employee:=:1)', 0, '', 'minwidth200imp', $noactive);
			?>
			</div>
			</td>
		</tr>
