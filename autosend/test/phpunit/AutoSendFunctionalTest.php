...
/**
 * \file    test/phpunit/AutoSendFunctionalTest.php
 * \ingroup autosend
 ...
 *
 * @package Testautosend
 */
class AutoSendFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/autosend/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('autosend/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/autosend/admin/about.php');
		$this->authenticate();
		return $this->assertContains('autosend/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('autosendwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modAutoSend_AutoSendTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modAutoSend_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
